...
class Video {
     ...
     * @param integer $create_time       Unix Timestamp representation of the creation date/time
     ...
     * @param integer $like_count        number of Likes received by the Video
     * @param integer $comment_count     number of Comments received by the Video
     * @param integer $share_count       number of Shares received by the Video
     * @param integer $view_count        number of Views received by the Video
     * @return void
     */
  ...
  *
     * @return integer Time of Creation
     */
  ...
  *
     * @return integer Height of the Video
     */
  ...
  *
     * @return integer Width of the Video
     */
  ...
  *
     * @return integer Likes of the Video
     */
  ...
  *
     * @return integer Comments of the Video
     */
  ...
  *
     * @return integer Shares of the Video
     */
  ...
  *
     * @return integer Views of the Video
     */
